...
#Globals
inpTweets = csv.reader(codecs.open('data/twitts.csv', 'r'), delimiter=',', quotechar='"')
stopWords = getStopWordList('data/feature_list/stopwords.txt')
out1 = codecs.open('data/logs/out_processedTweets.txt', 'w')
out2 = codecs.open('data/logs/out_twitts_features.txt', 'w')
out3 = codecs.open('data/logs/out_feature_vector.txt', 'w')
out4 = codecs.open('data/logs/out_badly_classfied.txt', 'w')
count = 0;
featureList = []
tweets = []
testTweets = [] 
